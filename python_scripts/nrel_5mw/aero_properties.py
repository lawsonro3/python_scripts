...
class NREL_5MW(object):
    ...
    '''
    def __init__(self):
        self.headers = np.array(['raidus (m)','node (-)','r_nodes (meters)','aero_twist (degrees)','dr_nodes (meters)','chord (meters)', 'airfoil_name (-)'])
        self.radius = 63.0
        ...
        self.dr_nodes = np.array([2.7333, 2.7333, 2.7333, 4.1, 4.1, 4.1, 4.1, 4.1, 4.1, 4.1, 4.1, 4.1, 4.1, 4.1, 2.7333, 2.7333, 2.7333])
